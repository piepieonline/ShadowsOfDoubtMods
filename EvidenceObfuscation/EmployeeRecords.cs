        ...
        public class Toolbox_Start
        {
            public static void Postfix(ref Toolbox __instance)
            {
                if(EvidenceObfuscationPlugin.EmployeeRecord_Printed_FingerprintsRemoved.Value)
                {
                    ...
                    EvidenceObfuscationPlugin.RemoveMessageMatching(Toolbox.Instance.allDDSTrees["10084020-1a7d-4048-8885-28c8985199e1"], "FingerprintPhoto");
                ...
                if (EvidenceObfuscationPlugin.EmployeeRecord_Filling_FingerprintsRemoved.Value)
                {
                    ...
                    EvidenceObfuscationPlugin.RemoveMessageMatching(Toolbox.Instance.allDDSTrees["674940fb-2f4a-4f15-8675-5864a5296c8b"], "FingerprintPhoto");
